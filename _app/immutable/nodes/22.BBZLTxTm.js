import"../chunks/CWj6FrbW.js";import"../chunks/wPM4U2Nx.js";import{s as e,f as R,n}from"../chunks/ChQ8i3mT.js";import{t as C,e as r,a as i}from"../chunks/CwLvwI_u.js";import{s as E}from"../chunks/BpXxpba2.js";import{S as t}from"../chunks/7Ikl-ixd.js";import{T as H}from"../chunks/CU_wdFVd.js";const L=""+new URL("../assets/RET_1.CV2u3p39.png",import.meta.url).href;var A=C(`<h1>Runtime Evaluation</h1> <p>Up until now, all of our code has been executing at <i>compile-time</i> . This is great because it allows us to catch errors early and keep our production code optimized
		...
		nest <code>run</code> expressions like this.</p> <h2 id="runtime-evaluation-tree">The Runtime-Evaluation Tree</h2> <p>Let's get a little more detailed about how runtime evaluation works. Cabin models runtime
		...
		equivalent to using <code>-- --</code> .</p> <p>Note that unlike many programming languages, the first value in <code>command_line_arguments()</code> isn't the location of the program; It's the first actual argument. You can get the location of the
		program with <code>program_location()</code> . Note that calling <code>program_location()</code> at compile-time will return the path to the project's <code>cabin.toml</code> .</p>`,1);function N(k){H(k,{page:"Runtime Evaluation",children:($,F)=>{var s=A(),l=e(R(s),8);t(l,{language:"cabin",code:`
			print("Hello!");
		`});var d=e(l,4);t(d,{language:"cabin",code:`
			run(print("Hello!"));
		`});var c=e(d,6);t(c,{language:"cabin",code:`
			let stored_run = run; # invalid
		`});var u=e(c,6);t(u,{language:"cabin",code:`
			run(print(2 + 3));
		...
		`});var h=e(p,10);t(h,{language:"cabin",code:`
			...
			let c = a + 2;
			let d = a + b;
		`});var g=e(h,4);E(g,"src",L);var b=e(g,8);t(b,{language:"cabin",code:`
		...
		`});var I=e(y,4);t(I,{language:"bash",code:`
			cabin run --- some2 arg2 --flag2 -i
		`}),n(4),i($,s)}})}export{N as component};
