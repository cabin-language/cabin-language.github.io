import"../chunks/CWj6FrbW.js";import"../chunks/wPM4U2Nx.js";import{s as e,f as u,n as g}from"../chunks/ChQ8i3mT.js";import{t as b,a as m}from"../chunks/CwLvwI_u.js";import{S as t}from"../chunks/7Ikl-ixd.js";import{T as f}from"../chunks/CU_wdFVd.js";var y=b(`<h1>Basic Types &amp; Operations</h1> <p>We're going to take some time to go over the basic types and operations you can perform on them
		...
		of the right operand.</p> <!> <p>The <code>::</code> operator always gives the <b>direct property value</b> . This isn't necessarily what you always want. More often than not you'll use the dot operator instead.</p> <h3 id="dot">The Dot Operator</h3> <p>The <b>dot</b> ( <code>::</code> ) operator is a little bit more nuanced. It operates differently depending on the type of it's left
		...
		these topics.</p> <p>If the left operand is an <b>either</b> , the either variant with the name of the right operand is returned. In terms of the <code>::</code> operator, the following expressions are equivalent:</p> <!> <p>If the left operand is a <b>group</b> , the group field with the name of the right operand is returned. In terms of the <code>::</code> operator, the following expressions are equivalent:</p> <!> <p>Otherwise, if the left operand has a property with the name of the right operand and that
		property is an <code>action</code> with the first argument being <code>this: This</code> , then a <b>partial action</b> is returned with the first argument set to the left operand:</p> <!> <p>Overall, the <code>.</code> operator is complex, but often more-or-less "does what you expect it to".</p>`,1);function q(d){f(d,{page:"Basic Types & Operations",children:(c,v)=>{var o=y(),a=e(u(o),12);t(a,{language:"cabin",code:`
			let greeting = "Hello";
			let name = "Jack";
		...
		`,output:"Hello Jack"});var n=e(a,4);t(n,{language:"cabin",code:`
			...
			debug("{greeting} {name}");
		`,output:"Hello Jack"});var i=e(n,4);t(i,{language:"cabin",code:`
			debug("Cabin is {"so ".repeat(3)}awesome!");
		`,output:"Cabin is so so so awesome!"});var r=e(i,8);t(r,{language:"cabin",code:`
			let Boolean = either {
				true,
				false
			};
		`});var s=e(r,12);t(s,{language:"cabin",code:`
			let length = "some text".length;
		`});var l=e(s,10);t(l,{language:"cabin",code:`
		...
		`});var h=e(p,4);t(h,{language:"cabin",code:`
			let Person = group {
				name: Text,
				age: Number,
		...
		`}),g(2),m(c,o)}})}export{q as component};
