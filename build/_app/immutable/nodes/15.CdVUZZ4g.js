import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{$ as d,s as e,f as c,n as l}from"../chunks/CLrxCXow.js";import{h}from"../chunks/DR8CSxid.js";import{t as m,a as f}from"../chunks/DB0DeKnA.js";import{S as o}from"../chunks/C-fuNUsz.js";import{T as g}from"../chunks/DDh1FhEA.js";var u=m(`<h1>Loops</h1> <h2 id="foreach">For-Each Loops</h2> <p>The first and most common type of loop is the <code>foreach</code> loop. The <code>foreach</code> loop allows looping over a list:</p> <!> <p>Just like <code>if</code> expressions, loops are terminated with a semicolon. This is a statement, and statements end with
		...
		over a list of people, and if we find one with the first name <code>"danny"</code> , we break from the loop and assign that person to <code>danny</code> .</p>`,1);function L(r){h(n=>{d.title="Loops • Cabin Docs"}),g(r,{page:"Loops",children:(n,b)=>{var a=u(),t=e(c(a),6);o(t,{language:"cabin",code:`
			foreach ghost in ["skulker", "johnny", "ember"] {
				print(ghost);
			};
		`});var i=e(t,6);o(i,{language:"cabin",code:`
		...
		`}),l(2),f(n,a)}})}export{L as component};
