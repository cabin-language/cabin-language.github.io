import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{$ as V,q as a,o as S,z as E}from"../chunks/DneM_Zg5.js";import{h as k}from"../chunks/DhpMl-z_.js";import{t as r,a as o}from"../chunks/Ke2h0E31.js";import{C as s}from"../chunks/DKDCHilS.js";import{D as A}from"../chunks/7eKlL1Ym.js";import{S as i}from"../chunks/BHDJhEEB.js";var R=r(`<pre>let TextExtension = extensionof Text &lbrace;
...
let CircleIsShape = extensionof Circle tobe Shape &lbrace;
    ...
    &rbrace;
&rbrace;;
</pre>`),q=r(`<pre>let surface_area = action(faces: Shape[]) &lbrace;
    #[editable] let total = 0;
    foreach shape in faces &lbrace;
...
</pre>`),j=r(`<pre>let Addable = group &lbrace;
...
&rbrace;;
		...
		doesn't <i>know</i> they're actions, they're simply referenced as a property and automatically called.</p> <p>Some important points about extension getters:</p> <ul><li>The signature of the getter must exactly match <code>action(this: This): PropertyType</code></li> <li>All getters are automatically marked with <code>#[no_side_effects]</code> . This means you cannot interact with the system in any way from getters, such as printing to the
			...
			indefinitely.</li></ul>`,1);function oe(P){k(c=>{V.title="Extensions  •  Cabin Docs"}),A(P,{page:"Extensions",children:(c,K)=>{var l=J(),d=a(S(l),8);i(d,{children:(e,n)=>{var t=R();o(e,t)}});var p=a(d,4);i(p,{children:(e,n)=>{var t=O();o(e,t)}});var h=a(p,4);i(h,{children:(e,n)=>{var t=D();o(e,t)}});var b=a(h,6);i(b,{children:(e,n)=>{var t=F();o(e,t)}});var u=a(b,4);i(u,{children:(e,n)=>{var t=G();o(e,t)}});var m=a(u,4);i(m,{children:(e,n)=>{var t=I();o(e,t)}});var y=a(m,4);i(y,{children:(e,n)=>{var t=W();o(e,t)}});var g=a(y,4);i(g,{children:(e,n)=>{var t=q();o(e,t)}});var f=a(g,6);i(f,{children:(e,n)=>{var t=j();o(e,t)}});var x=a(f,4);i(x,{children:(e,n)=>{var t=B();o(e,t)}});var w=a(x,4);i(w,{children:(e,n)=>{var t=L();o(e,t)}});var v=a(w,4);i(v,{children:(e,n)=>{var t=z();o(e,t)}});var _=a(v,4);i(_,{children:(e,n)=>{var t=M();o(e,t)}});var T=a(_,8);i(T,{children:(e,n)=>{var t=H();o(e,t)}});var $=a(T,14);s($,{code:`
