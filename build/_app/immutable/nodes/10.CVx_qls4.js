import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{$ as V,s as a,f as S,n as E}from"../chunks/BydpiCg8.js";import{h as k}from"../chunks/Bn7yGRp9.js";import{t as r,a as o}from"../chunks/Dt90oPg1.js";import{C as s}from"../chunks/DZNc80e9.js";import{D as A}from"../chunks/BzOU4ukw.js";import{S as i}from"../chunks/CShp_DQN.js";var R=r(`<pre>let TextExtension = extensionof Text &lbrace;
    is_danny = action(this: Text): Boolean &lbrace;
        is_danny is this == "danny";
    &rbrace;
&rbrace;;
</pre>`),O=r(`<pre>let danny_is_danny = "danny".is_danny(); # true
let sam_is_danny = "sam".is_danny(); # false
</pre>`),D=r(`<pre>let DannyExtension = text.TextExtension; # required

let danny_is_danny = "danny".is_danny(); # true
</pre>`),F=r(`<pre>let Rectangle = group &lbrace;
    width: Number,
    height: Number,
...
let Circle = group &lbrace;
    ...
    &rbrace;
&rbrace;;
</pre>`),G=r(`<pre>let Shape = either &lbrace;
    rectangle: Rectangle,
    circle: Circle
&rbrace;;
...
</pre>`),I=r(`<pre>let Shape = group &lbrace;
    area: action(this: This): Number
&rbrace;;
</pre>`),W=r(`<pre>let RectangleIsShape = extensionof Rectangle tobe Shape &lbrace;
    area = action(this: This): Number &lbrace;
        area is this.width * this.height;
    &rbrace;
&rbrace;;
...
let CircleIsShape = extensionof Circle tobe Shape &lbrace;
    ...
    &rbrace;
&rbrace;;
</pre>`),j=r(`<pre>let surface_area = action(faces: Shape[]) &lbrace;
    #[editable] let total = 0;
    foreach shape in faces &lbrace;
...
</pre>`),q=r(`<pre>let Addable = group &lbrace;
    plus: action(this: This, other: This): This
&rbrace;;
</pre>`),B=r(`<pre>let Vector = group &lbrace;
    x: Number,
    y: Number
&rbrace;;
</pre>`),L=r(`<pre>let AddVectors = extensionof Vector tobe Addable &lbrace;
    plus = action(this: This, other: This): This &lbrace;
        it is new Vector &lbrace; x = this.x + other.x, y = this.y + other.y &rbrace;;
    &rbrace;
&rbrace;;
</pre>`),M=r(`<pre>let a = new Vector &lbrace; x = 10, y = 20 &rbrace;;
let b = new Vector &lbrace; x = 15, y = 5 &rbrace;;

let sum = a + b;
</pre>`),z=r(`<pre>let a = new Vector &lbrace; x = 10, y = 20 &rbrace;;
let b = new Vector &lbrace; x = 15, y = 5 &rbrace;;
...
let AddVectors = extensionof Vector tobe Addable &lbrace;
    ...
    &rbrace;
&rbrace;;
</pre>`),J=r(`<h1>Extensions</h1> <p><b>Extensions</b> are how Cabin implements polymorphism, as well as allowing foreign types to be extended with additional
		...
		doesn't <i>know</i> they're actions, they're simply referenced as a property and automatically called.</p> <p>Some important points about extension getters:</p> <ul><li>The signature of the getter must exactly match <code>action(this: This): PropertyType</code></li> <li>All getters are automatically marked with <code>#[no_side_effects]</code> . This means you cannot interact with the system in any way from getters, such as printing to the
			...
			indefinitely.</li></ul>`,1);function oe(P){k(c=>{V.title="Extensions  •  Cabin Docs"}),A(P,{page:"Extensions",children:(c,K)=>{var l=J(),d=a(S(l),8);i(d,{children:(e,n)=>{var t=R();o(e,t)}});var p=a(d,4);i(p,{children:(e,n)=>{var t=O();o(e,t)}});var h=a(p,4);i(h,{children:(e,n)=>{var t=D();o(e,t)}});var b=a(h,6);i(b,{children:(e,n)=>{var t=F();o(e,t)}});var u=a(b,4);i(u,{children:(e,n)=>{var t=G();o(e,t)}});var m=a(u,4);i(m,{children:(e,n)=>{var t=I();o(e,t)}});var y=a(m,4);i(y,{children:(e,n)=>{var t=W();o(e,t)}});var g=a(y,4);i(g,{children:(e,n)=>{var t=j();o(e,t)}});var f=a(g,6);i(f,{children:(e,n)=>{var t=q();o(e,t)}});var x=a(f,4);i(x,{children:(e,n)=>{var t=B();o(e,t)}});var w=a(x,4);i(w,{children:(e,n)=>{var t=L();o(e,t)}});var v=a(w,4);i(v,{children:(e,n)=>{var t=M();o(e,t)}});var _=a(v,4);i(_,{children:(e,n)=>{var t=z();o(e,t)}});var T=a(_,8);i(T,{children:(e,n)=>{var t=H();o(e,t)}});var $=a(T,14);s($,{code:`
	...
	`}),E(6),o(c,l)},$$slots:{default:!0}})}export{oe as component};
